...
# each method:
all.data <- list(Colony2.0.5.7=col.new,
                 ColonyP2.0.5.7=col.new.pair,
                 Colony=col.med, 
...
latex.prog.names <- c("\\colony{} version 2.0.5.7", "\\colony{}-P version 2.0.5.7", "\\colony{}-P version 2.0", "\\colony{} version 2.0", "\\prt{}", "\\familyfinder{}", "\\kinalyzer{} 2-allele", "\\kinalyzer{} consense", 
                      "\\colony{} assuming moderate error rate", "\\colony{} assuming no genotyping error", "\\colony{} assuming a high error rate")
names(latex.prog.names) <- c("Colony2.0.5.7", "ColonyP2.0.5.7", "ColonyP", "Colony", "PRT", "FamilyFinder", "Kinalyzer", "KinaConsense", 
                             "Colony d=0.02, m=0.02", "Colony d=0 m=0", "Colony d=0.07 m=0.03")
labstrs <- c("Colony d=0 m=0", "Colony d=0.07 m=0.03", "Colony d=0.02, m=0.02", "Colony version 2.0", "Colony version 2.0.5.7")

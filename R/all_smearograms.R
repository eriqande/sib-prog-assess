...
load("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/PRT_April_1_2014_party_dists.rda")
prt.all <- PRT_party_dists
rm(PRT_party_dists)

col.all <- read.table("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/Colony_Results_All.txt",header=T);
kina.all <- read.table("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/Kinalyzer75s_PDs_and_Time.txt",header=T);
ff.all <- read.table("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/FamilyFinderAll.txt",header=T);
cons.all <- read.table("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/KinaConsense75_PDs.txt",header=T);  # kinalyzer with consense option
...
col.pair.all <- read.table("/Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/Colony_Pairwise_Results_All.txt",header=T);
...
# now we cycle over all the various pairwise comparisons:

%% Big NOTE! 
% The figures for this document are big enough that I don't want
% them sitting around on my hard drive. So, you have to run the
% script:
% /Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/FinalOutputs/plot/all_smearograms.R
% and that makes all the figures in a directory in /tmp.
% then the contents of:
%/tmp/sib_assess_plots/OrderedListOfFiles.txt
% hold all the latex source that you want to put into
% /Users/eriq/Documents/work/prj/AlmudevarCollab/SibProgramsEvaluation/doc/suppl1/suppl1_figure_calls.tex
% which gets called from this file

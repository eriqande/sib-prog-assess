...
We used the C program {\em nookie} (written by ECA and available at \url{https://github.com/eriqande/nookie}) to simulate each of the data sets.  
...
We consequently re-ran a subset of our data sets (kindly suggested by J.~Wang) with this new version, \colony{}-2.0.5.0, to highlight the improvements.
...
With even less-informative data (such as $A=5$ and $L=5$) the performance of all methods is, predictably, 

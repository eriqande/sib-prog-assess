...
formulation does not penalize set cover solutions.  So, for example, if  $U=\{1,2,3,4,5,6\}$, $T=\
{\{1,2,3\},\{4,5,6\}\}$, and $C=\{\{1,2,3,4\}, \{3,4,5,6\}\}$, then $\W(C,T)=0$, but the partition 
...
reason, in Supplement~3, we include a series of plots showing the size of the largest inferred sibling 
...
\begin{figure}
\begin{center}
\includegraphics[width=.9\textwidth]{images/various_kin_smear.jpg}  %% Change extension from jpg to pdf for final version
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=.9\textwidth]{images/prt_ff_pair_smear.jpg}  %% Change extension from jpg to pdf for final version
\end{center}
